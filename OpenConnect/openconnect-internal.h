...
int compress_packet(struct openconnect_info *vpninfo, int compr_type, struct pkt *this_pkt);
...
int config_lookup_host_a(struct openconnect_info *vpninfo, const char *host);
...
{
    const struct oc_packed_uint32_t *p = (struct oc_packed_uint32_t *)_p;
    return ntohl(p->d);
}

static inline uint16_t load_be16(const void *_p)
{
    const struct oc_packed_uint16_t *p = (struct oc_packed_uint16_t *)_p;
    return ntohs(p->d);
}

static inline void store_be32(void *_p, uint32_t d)
{
    struct oc_packed_uint32_t *p = (struct oc_packed_uint32_t *)_p;
    p->d = htonl(d);
}

static inline void store_be16(void *_p, uint16_t d)
{
    struct oc_packed_uint16_t *p = (struct oc_packed_uint16_t *)_p;
    p->d = htons(d);
}
